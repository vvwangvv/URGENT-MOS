...
def main():
    ...
    for original_path in args.original_path:
        ...
        for line in tqdm(filelist, desc="Processing CSV metadata"):
            ...
            reference_id = wav_path.replace(".wav", "").replace(os.sep, "_")
            system_id = reference_id  # no system ID information
            item = {
    ...
    fieldnames = ["wav_path", "score", "system_id", "reference_id", "dimension"]
